...
const useRandomForest = ()=>{
    ...
    const actions = {
        ...
        trainModel: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
            "useRandomForest.useCallback": async ()=>{
                setStatus('loading');
                try {
                    const currentDataset = state.task === 'regression' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$california$2d$housing$2e$json__$28$json$29$__["default"] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$wine$2d$quality$2e$json__$28$json$29$__["default"];
                    const trainedData = await mockTrainModel(state, currentDataset);
                    setData({
                        "useRandomForest.useCallback": (d)=>({
                                ...d,
                                ...trainedData,
                                insights: ''
                            })
                    }["useRandomForest.useCallback"]);
                    const featureImportancesForAI = trainedData.featureImportance.reduce({
                        "useRandomForest.useCallback.featureImportancesForAI": (acc, item)=>{
                            acc[item.feature] = item.importance;
                            return acc;
                        }
                    }["useRandomForest.useCallback.featureImportancesForAI"], {});
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$02144b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getFeatureImportanceInsights"])({
                        ...
                        "useRandomForest.useCallback": (insights)=>{
                            setData({
                                "useRandomForest.useCallback": (d)=>({
                                        ...d,
                                        insights
                    ...
                    }["useRandomForest.useCallback"]).catch({
                        "useRandomForest.useCallback": (err)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRandomForest.useEffect": ()=>{
            ...
            }["useRandomForest.useEffect.handler"], 1000); // 1-second debounce
            return ({
                "useRandomForest.useEffect": ()=>{
...
_s(useRandomForest, "0tYhck6O0dMStQi6eq3YCkJkQ1w=", false, function() {
    return [
...
//# sourceMappingURL=src_dc8cc15c._.js.map